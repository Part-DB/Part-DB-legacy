	...
	<tr>
		...
		if ($prevcat != $d[6])
		{
			/* this part is in a different category than
			   the previous. */
			print "<tr><td>Treffer in der Kategorie ". show_bt($d[6]) ."</td></tr>\n";
			print "<tr class=\"trcat\"><td>Name</td><td>Vorhanden</td><td>Min. Bestand</td><td>Footprint</td><td>Lagerort</td></tr>\n";
			$prevcat = $d[6];
			$rowcount = 0;
		}
