...
if (!defined('vlibMimeMailClassLoaded')) {
    ...
    \-----------------------------------------------------------------------------*/
        ...
        var $htmlcharset = "iso-8859-1";
        var $htmlctencoding = "8bit";
    ...
    \-----------------------------------------------------------------------------*/
         ...
         * charset.
         *  i.e. $mail->body('ce message est en fran�is.', 'iso-8859-1');
         *
         ...
         * If you're sending a mail with special characters, be sure to define the
         * charset.
         *  i.e. $mail->htmlbody('ce message est en fran�is.', 'iso-8859-1');
         *
