...
/*
    ...
    20120829 weinbauer73@gmail.com
    - adding head_switch_ds_path-switch
*/
...
class HTML
{
    ...
    function __construct ()
    {
        ...
        settype ($this->meta['switch_ds_path'],'boolean');
        ...
        $this->meta['switch_ds_path']=false;
        $this->meta['id']=false;
        $this->grab=false;
    ...
    function print_html_header ()
    {
        ...
        $tmpl -> setVar('head_switch_ds_path', $this->meta['switch_ds_path']);
