...
*/
     ...
     */
    function extract_import_data_from_request($table_rowcount)
    {
     ...
     */
    function import_text_to_array($text, $format, $separator = ';')
    {
        global $config;
        global $import_data_columns;
        global $import_data_column_datatypes;
     ...
     * @throws Exception if there was an error
     */
    function build_parts_import_template_loop(&$database, &$current_user, &$log, $data)
    {
        $loop = array();
     ...
     * @throws Exception if there was an error
     */
    function build_deviceparts_import_template_loop(&$database, &$current_user, &$log, $data)
    {
        $loop = array();
