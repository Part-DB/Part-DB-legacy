<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-md-3">
                <b>{t}4-stellig{/t}</b><p>{t}Die ersten drei Stellen sind der Wert, die letzte Stelle ist der Exponent z.B.{/t}</p>
            </div>
            <div class="col-md-3">
                <div class="thumbnail">
        ...
        <div class="row">
            <div class="col-md-3">
                <b>{t}Mehrstellig mit R{/t}</b><p>{t}Das R zählt als Dezimalpunkt z.B.{/t}</p>
            </div>
            <div class="col-md-3">
                <div class="thumbnail">
