...
<div class="card d-print-none mt-3">
    ...
    <div class="card-collapse collapse show" id="panel-history">
        <ul class="nav nav-tabs mt-1 ml-1">
            <li class="nav-item">
                <a class="nav-link active link-anchor" data-toggle="tab" href="#graph" role="tab"><i class="fas fa-chart-line fa-fw"></i> {t}Graph{/t}</a>
            </li>
            <li class="nav-item">
                <a class="nav-link link-anchor" data-toggle="tab" href="#table" role="tab"><i class="fas fa-table fa-fw"></i> {t}Tabelle{/t}</a>
            </li>
        </ul>
