            ...
            <div class="tab-content">
                ...
                <div id="tab2" class="tab-pane fade">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="default_comment_withdrawal" class="form-control" value="{$default_comment_withdrawal}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="default_comment_addition" class="form-control" value="{$default_comment_addition}"
                                   placeholder="{t}z.B. Projekt ABC{/t}"/>
                        </div>
                    </div>
