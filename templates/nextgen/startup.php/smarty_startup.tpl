...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        ...
        <strong><i class="fas fa-hospital fa-fw"></i> Forum:</strong> {t escape=false link="https://www.mikrocontroller.net/topic/438916"}Für Fragen rund um die Part-DB gibt es einen Thread auf <a class="link-external" target="_blank" href="%1">mikrocontroller.net</a>{/t}<br>
