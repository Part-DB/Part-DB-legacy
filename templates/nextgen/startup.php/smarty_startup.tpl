...
<div class="panel panel-primary">
    ...
    <div class="panel-body">
        ...
        <strong>{t}Projektseite:{/t}</strong> {t}Downloads, Bugreports, ToDo-Liste usw. gibts auf der <a class="link-external" target="_blank" href="https://github.com/do9jhb/Part-DB/">GitHub Projektseite</a>{/t}<br>
        <strong>{t}Hilfe{/t}</strong> {t}Hilfe und Tipps finden sie im <a class="link-external" href="https://github.com/jbtronics/Part-DB/wiki" target="_blank">Wiki</a> der GitHub Seite.{/t} <br>
        <strong>Forum:</strong> {t}Für Fragen rund um die Part-DB gibt es einen Thread auf <a class="link-external" target="_blank" href="https://www.mikrocontroller.net/topic/305023">mikrocontroller.net</a>{/t}<br>
        <strong>Wiki:</strong> {t}Weitere Informationen gibt es im <a class="link-external" target="_blank" href="http://www.mikrocontroller.net/articles/Part-DB_RW_-_Lagerverwaltung">mikrocontroller.net Artikel</a>{/t}<br>
        <br>
