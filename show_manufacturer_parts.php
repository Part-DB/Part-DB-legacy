...
try {
    ...
    $manufacturer = Manufacturer::getInstance($database, $current_user, $log, $manufacturer_id);
    ...
    $html->setTitle(_('Teileansicht') . ': ' . $manufacturer->getName());
...
$html->setVariable('with_submanufacturers', $with_submanufacturers, 'boolean');
...
if (! $fatal_error) {
    $html->printTemplate('show_manufacturer_parts');
}
