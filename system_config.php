...
$popup_width                = isset($_POST['popup_width'])       ? (int)$_POST['popup_width']     : $config['popup']['width'];
$popup_height               = isset($_POST['popup_height'])      ? (int)$_POST['popup_height']    : $config['popup']['height'];
