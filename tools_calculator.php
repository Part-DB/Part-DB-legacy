...
$html = new HTML($config['html']['theme'], $user_config['theme'], _('Widerstandsrechner'));
...
try {
    ...
    $current_user->tryDo(\PartDB\Permissions\PermissionManager::TOOLS, \PartDB\Permissions\ToolsPermission::CALCULATOR);
} catch (Exception $e) {
