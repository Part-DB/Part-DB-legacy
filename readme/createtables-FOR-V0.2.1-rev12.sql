...
--
-- Host: localhost:3306
-- Erstellungszeit: 12. Juli 2012 um 15:21
-- Server Version: 5.1.36
-- PHP-Version: 5.3.0

DROP DATABASE IF EXISTS `DB_NAME`;
CREATE DATABASE `DB_NAME` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
GRANT USAGE ON *.* TO `DB_NAME`@`DB_HOST` IDENTIFIED BY "DB_PASS_PARTDB";
GRANT ALL PRIVILEGES ON `DB_NAME`.`*` TO `DB_USER_PARTDB`@`DB_HOST`;
USE `DB_NAME`;
