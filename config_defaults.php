...
*/
    ...
    *********************************************************************************/
    ...
    $config['system']['latest_config_version']              = 1; // only increase for one!
    ...
    $config['languages']['de_AT']                           = 'de_AT';
    $config['languages']['de_CH']                           = 'de_CH';
    $config['languages']['de_DE']                           = 'de_DE';
    $config['languages']['en_GB']                           = 'en_GB';
    $config['languages']['en_US']                           = 'en_US';
    $config['languages']['de_AT.utf8']                      = 'de_AT (UTF-8)';
    $config['languages']['de_CH.utf8']                      = 'de_CH (UTF-8)';
    $config['languages']['de_DE.utf8']                      = 'de_DE (UTF-8)';
    $config['languages']['en_GB.utf8']                      = 'en_GB (UTF-8)';
    $config['languages']['en_US.utf8']                      = 'en_US (UTF-8)';

    // currency formats (for every language [but without attributes like "utf8"] there must be a currency format!)
